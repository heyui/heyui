  ...
  methods: {
    ...
    initTreeModeData(list, isWait, parentKey) {
      ...
      for (let data of list) {
        let obj = { key: data[this.param.keyName], title: data[this.param.titleName], value: data, parentKey, icon: data.treeIcon,  status: { hide: false, opened: false, loading: false, checkable: data.checkable===false ? false : true, isWait, selected: false, indeterminate: false, choose: false, disabled: !!data.disabled } };
