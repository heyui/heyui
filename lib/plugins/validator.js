define(["heyui/lib/locale"], function(__WEBPACK_EXTERNAL_MODULE__7__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var _heyUtils = _interopRequireDefault(__webpack_require__(182));

var _typeValids = _interopRequireDefault(__webpack_require__(183));

var _baseValids = _interopRequireDefault(__webpack_require__(184));

var _combineValids = _interopRequireDefault(__webpack_require__(185));

var extendResult = function extendResult(result1, result2) {
  var result = {};
  var keys = new Set([].concat(Object.keys(result1), Object.keys(result2)));
...
var ruleExecute = function ruleExecute(rule, argus) {
  if (_heyUtils.default.isFunction(rule)) {
    return rule.call.apply(rule, [null].concat(argus));
