define(["heyui/lib/utils/utils","heyui/lib/locale","vue"], function(__WEBPACK_EXTERNAL_MODULE__51__, __WEBPACK_EXTERNAL_MODULE__83__, __WEBPACK_EXTERNAL_MODULE__690__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
var _vue = _interopRequireDefault(__webpack_require__(690));
...
function () {
  function Notify(orignalparam) {
    ...
    if (param.component != undefined && _vue.default) {
      this.vue = new _vue.default({
        el: $content,
        i18n: param.$i18n,
        router: param.$router,
...
module.exports = __WEBPACK_EXTERNAL_MODULE__690__;
