define(["heyui/lib/components/checkbox"], function(__WEBPACK_EXTERNAL_MODULE__102__) { return /******/ (function(modules) { // webpackBootstrap
/******/ 	// The module cache
...
/* harmony import */ var _hey_cli_node_modules_babel_loader_lib_index_js_ref_5_0_hey_cli_node_modules_vue_loader_lib_index_js_vue_loader_options_transfer_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(257);
...
var _default2 = {
  ...
  methods: {
    move: function move(direction) {
      ...
      var value = this.value ? [].concat(this.value) : [];

      if (direction === 1 && this.ltChecked.length > 0) {
        this.rtSearchText = null;
        value.push.apply(value, this.ltChecked);
...
var _transfer = _interopRequireDefault(__webpack_require__(563));
...
"use strict";
__webpack_require__.r(__webpack_exports__);
/* harmony import */ var _transfer_vue_vue_type_template_id_90850ba2___WEBPACK_IMPORTED_MODULE_0__ = __webpack_require__(313);
/* harmony import */ var _transfer_vue_vue_type_script_lang_js___WEBPACK_IMPORTED_MODULE_1__ = __webpack_require__(256);
