...
const router = {
  ...
  routes: [{
    ...
    children: [{
      ...
      component: () =>
        import ('components/component/basic/layout')
    }, {
      path: 'basic/color',
      name: 'basicColor',
      meta: {
      ...
      component: () =>
        import('components/component/view/imagepreview')
    },{
      path: 'view/carousel',
      name: 'viewCarousel',
      meta: {
    ...
    }, 
    {
      ...
      component: () =>
        import ('components/resource/heysnippets')
    }]
  }, {
    path: '/resource',
    ...
    children: [{
      ...
      component: () =>
        import ('components/resource/heycli')
    },{
      path: 'heycli',
      name: 'heycli',
      meta: {
      ...
      component: () =>
        import ('components/resource/heyutils')
    },{
      path: 'heyvalidator',
      name: 'heyvalidator',
      meta: {
      ...
      component: () =>
        import ('components/resource/heyvalidator')
    },{
      path: 'manba',
      name: 'manba',
      meta: {
      ...
      component: () =>
        import ('components/resource/manba')
    },{
      path: 'model',
      name: 'model',
      meta: {
      ...
      component: () =>
        import ('components/resource/model')
    },{
      path: 'umock',
      name: 'umock',
      meta: {
      ...
      component: () =>
        import ('components/resource/umock')
    },{
      path: 'heysnippets',
      name: 'heysnippets',
      meta: {
