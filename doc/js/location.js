...
function toCityData(data) {
  let result = toTreeData(data).filter(item => !municipality[item.id]);
...
exports.CHINALOCATION = [...toTreeData(PROVINCE), ...toCityData(CITY)];
exports.HONGKONG = toTreeData(HONGKONG);
exports.TAIWAN = toTreeData(TAIWAN);
exports.MALAYSIA = toTreeData(MALAYSIA);
exports.COUNTRY = toList(COUNTRY);
