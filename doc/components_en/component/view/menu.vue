  ...
  <div class="doc">
    ...
    <table class="table">
      ...
      <tr>
        ...
        <td>Object</td>
        <td>-</td>
        <td>Global configuration <code>config.menu</code></td>
      </tr>
      <tr>
        <td>className</td>
        <td>Custom class</td>
    ...
    <table class="table">
      ...
      <tr>
        <td>childrenName</td>
        <td>Menu's data childrenName</td>
        <td>String</td>
        <td>-</td>
        <td>children</td>
      </tr>
