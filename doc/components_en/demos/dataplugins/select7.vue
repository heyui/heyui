  ...
  <div>
    ...
    <div v-width="300">
      <Select v-model="select" :datas="param">
        <template slot-scope="{item}" slot="top"><div class="text-center">Custom head</div></template>
        ...
        <template slot-scope="{item}" slot="bottom"><div class="text-center">Custom bottom</div></template>
      </Select>
    </div>
  </div>
</template>
