  ...
  <div>
    <div style="padding-bottom: 20px">
      <Form readonly :labelWidth="130">
        <FormItem label="Automatic switching"><h-switch small v-model="autoplay"></h-switch></FormItem>
        <FormItem label="Left and right toggle button"><SwitchList small v-model="arrow" :datas="arrows"></SwitchList></FormItem>
        <FormItem label="Bottom indicator style"><SwitchList small v-model="pageTheme" :datas="pageThemes"></SwitchList></FormItem>
        <FormItem label="Bottom indicator trigger"><SwitchList small v-model="paginationTrigger" :datas="paginationTriggers"></SwitchList></FormItem>
        <FormItem label="Switching effect"><SwitchList small v-model="effect" :datas="effects"></SwitchList></FormItem>
      </Form>
    </div>
