<template>
  <div>
    <p>Value：{{ value }}</p>
    <p>Value type：<SwitchList v-model="type" :datas="{ key: 'id', object: 'object' }" small @change="changeValue"></SwitchList></p>
    <p>
    ...
    changeValue() {
      if (this.type == 'key') {
        ...
        this.value = this.multiple
          ? [
              { id: '310101', title: '黄浦', traditionalTitle: '黃浦', pinyinTitle: 'Huangpu', parentId: 310000 },
              { id: '310104', title: '徐汇', traditionalTitle: '徐匯', pinyinTitle: 'Xuhui', parentId: 310000 }
            ]
          : { id: '340102', title: '瑶海', traditionalTitle: '瑤海', pinyinTitle: 'Yaohai', parentId: '340100' };
      }
    }
  }
};
